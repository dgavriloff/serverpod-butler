...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1371: (x0,x1) => x0.getAttribute(x1),
      _1372: (x0,x1) => x0.createElement(x1),
      _1373: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1374: x0 => x0.decode(),
      ...
      _1439: (a, i) => a.push(i),
      _1440: (a, i) => a.splice(i, 1)[0],
      _1442: (a, l) => a.length = l,
      _1443: a => a.pop(),
      _1444: (a, i) => a.splice(i, 1),
      _1445: (a, s) => a.join(s),
      _1446: (a, s, e) => a.slice(s, e),
      _1447: (a, s, e) => a.splice(s, e),
      _1448: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1449: a => a.length,
      _1451: (a, i) => a[i],
      _1452: (a, i, v) => a[i] = v,
      _1454: o => {
      ...
      _1477: (t, s) => t.set(s),
      _1478: l => new DataView(new ArrayBuffer(l)),
      ...
      _1598: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1604: (x0,x1) => new WebSocket(x0,x1),
      _1605: (x0,x1) => x0.send(x1),
      _1606: (x0,x1,x2) => x0.close(x1,x2),
      _1608: x0 => x0.close(),
      ...
      _1620: (x0,x1) => x0.getUserMedia(x1),
      _1621: x0 => x0.getTracks(),
      _1622: () => new AudioContext(),
      _1623: x0 => x0.resume(),
      _1624: x0 => x0.createAnalyser(),
      _1625: (x0,x1) => x0.createMediaStreamSource(x1),
      _1626: (x0,x1) => x0.connect(x1),
      _1627: x0 => ({mimeType: x0}),
      _1628: (x0,x1) => new MediaRecorder(x0,x1),
      _1629: x0 => new MediaRecorder(x0),
      _1630: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1630(f,arguments.length,x0) }),
      _1631: (x0,x1) => x0.start(x1),
      _1632: () => new FileReader(),
      ...
      _1635: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1636: x0 => x0.stop(),
      _1637: x0 => x0.disconnect(),
      _1638: x0 => x0.close(),
      _1639: x0 => x0.stop(),
      _1640: (x0,x1) => x0.getByteFrequencyData(x1),
      _1641: x0 => x0.trustedTypes,
      _1642: (x0,x1) => { x0.src = x1 },
      _1643: (x0,x1) => x0.createScriptURL(x1),
      _1644: x0 => x0.nonce,
      _1645: (x0,x1) => x0.debug(x1),
      _1646: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1646(f,arguments.length,x0) }),
      _1647: x0 => ({createScriptURL: x0}),
      _1648: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1649: (x0,x1) => x0.appendChild(x1),
      _1650: (x0,x1) => x0.querySelectorAll(x1),
      _1651: x0 => x0.random(),
      ...
      _1671: () => new webkitSpeechRecognition(),
      ...
      _1676: x0 => x0.stop(),
      _1677: (x0,x1) => { x0.continuous = x1 },
      _1678: (x0,x1) => { x0.interimResults = x1 },
      _1679: (x0,x1) => { x0.lang = x1 },
      _1680: (x0,x1) => { x0.onresult = x1 },
      _1681: (x0,x1) => { x0.onerror = x1 },
      _1682: (x0,x1) => { x0.onend = x1 },
      _1684: x0 => x0.results,
      _1686: x0 => x0.length,
      _1687: (x0,x1) => x0.item(x1),
      _1690: (x0,x1) => x0.item(x1),
      _1691: x0 => x0.isFinal,
      _1692: x0 => x0.transcript,
      _1694: x0 => x0.error,
      ...
      _1815: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1816: f => finalizeWrapper(f, function() { return dartInstance.exports._1816(f,arguments.length) }),
      _2142: (x0,x1) => { x0.nonce = x1 },
      _3180: (x0,x1) => { x0.src = x1 },
      _3186: (x0,x1) => { x0.async = x1 },
      _3188: (x0,x1) => { x0.defer = x1 },
      _3649: () => globalThis.window,
      _3690: x0 => x0.document,
      _3693: x0 => x0.location,
      _3712: x0 => x0.navigator,
      _3974: x0 => x0.trustedTypes,
      _3987: x0 => x0.protocol,
      _3991: x0 => x0.hostname,
      _4085: x0 => x0.mediaDevices,
      _4152: x0 => x0.data,
      _4526: x0 => x0.readyState,
      _4535: x0 => x0.protocol,
      _4539: (x0,x1) => { x0.binaryType = x1 },
      _4542: x0 => x0.code,
      _4543: x0 => x0.reason,
      _5695: x0 => x0.sampleRate,
      _5698: x0 => x0.state,
      _5803: x0 => x0.fftSize,
      _5804: (x0,x1) => { x0.fftSize = x1 },
      _5805: x0 => x0.frequencyBinCount,
      _5807: (x0,x1) => { x0.minDecibels = x1 },
      _5809: (x0,x1) => { x0.maxDecibels = x1 },
      _5811: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6246: x0 => x0.signal,
      _6255: x0 => x0.length,
      _6316: () => globalThis.document,
      _6389: x0 => x0.cookie,
      _6390: (x0,x1) => { x0.cookie = x1 },
      _6399: x0 => x0.head,
      _6733: (x0,x1) => { x0.id = x1 },
      _8079: x0 => x0.value,
      _8081: x0 => x0.done,
      _8263: x0 => x0.size,
      _8284: x0 => x0.result,
      _8291: (x0,x1) => { x0.onload = x1 },
      _8295: (x0,x1) => { x0.onerror = x1 },
      _8663: (x0,x1) => { x0.ondataavailable = x1 },
      _8688: x0 => x0.data,
      _8778: x0 => x0.url,
      _8780: x0 => x0.status,
      _8782: x0 => x0.statusText,
      _8783: x0 => x0.headers,
      _8784: x0 => x0.body,
      _12407: x0 => x0.name,
      _13118: () => globalThis.console,
