...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1263: x0 => x0.length,
      _1338: x0 => globalThis.localStorage.getItem(x0),
      _1339: (x0,x1) => globalThis.localStorage.setItem(x0,x1),
      _1371: (x0,x1) => x0.item(x1),
      _1372: (x0,x1) => x0.querySelector(x1),
      _1373: (x0,x1) => x0.getAttribute(x1),
      _1374: (x0,x1) => x0.createElement(x1),
      ...
      _1439: Object.is,
      _1440: o => o instanceof Array,
      _1441: (a, i) => a.push(i),
      _1445: a => a.pop(),
      _1446: (a, i) => a.splice(i, 1),
      _1447: (a, s) => a.join(s),
      _1448: (a, s, e) => a.slice(s, e),
      _1450: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1451: a => a.length,
      _1453: (a, i) => a[i],
      _1454: (a, i, v) => a[i] = v,
      _1456: o => {
      ...
      _1457: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1459: o => o instanceof Uint8Array,
      _1460: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1461: o => o instanceof Int8Array,
      _1462: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1463: o => o instanceof Uint8ClampedArray,
      _1464: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1465: o => o instanceof Uint16Array,
      _1466: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1467: o => o instanceof Int16Array,
      _1468: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1469: o => o instanceof Uint32Array,
      _1470: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1471: o => o instanceof Int32Array,
      _1472: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1474: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1475: o => o instanceof Float32Array,
      _1476: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1477: o => o instanceof Float64Array,
      _1478: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1479: (t, s) => t.set(s),
      _1480: l => new DataView(new ArrayBuffer(l)),
      _1481: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1483: o => o.buffer,
      _1484: o => o.byteOffset,
      _1485: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1486: (b, o) => new DataView(b, o),
      _1487: (b, o, l) => new DataView(b, o, l),
      _1488: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1489: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1490: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1491: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1492: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1493: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1494: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1495: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1496: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1497: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1498: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1499: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1502: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1503: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1504: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1505: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1506: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1507: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1520: (ms, c) =>
      ...
      _1559: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1559(f,arguments.length,x0,x1) }),
      _1560: o => {
      ...
      _1607: (x0,x1) => x0.send(x1),
      _1608: (x0,x1,x2) => x0.close(x1,x2),
      _1610: x0 => x0.close(),
      ...
      _1619: x0 => x0.cancel(),
      _1620: x0 => x0.read(),
      _1621: (x0,x1) => ({video: x0,audio: x1}),
      _1622: (x0,x1) => x0.getUserMedia(x1),
      _1623: x0 => x0.getTracks(),
      _1624: () => new AudioContext(),
      _1625: x0 => x0.resume(),
      _1626: x0 => x0.createAnalyser(),
      _1627: (x0,x1) => x0.createMediaStreamSource(x1),
      _1628: (x0,x1) => x0.connect(x1),
      _1629: x0 => ({mimeType: x0}),
      _1630: (x0,x1) => new MediaRecorder(x0,x1),
      _1631: x0 => new MediaRecorder(x0),
      _1632: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1632(f,arguments.length,x0) }),
      _1633: (x0,x1) => x0.start(x1),
      _1634: () => new FileReader(),
      ...
      _1637: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1638: x0 => x0.stop(),
      _1639: x0 => x0.disconnect(),
      _1640: x0 => x0.close(),
      _1641: x0 => x0.stop(),
      _1642: (x0,x1) => x0.getByteFrequencyData(x1),
      _1643: x0 => x0.trustedTypes,
      _1644: (x0,x1) => { x0.src = x1 },
      _1645: (x0,x1) => x0.createScriptURL(x1),
      _1646: x0 => x0.nonce,
      _1647: (x0,x1) => x0.debug(x1),
      _1648: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1648(f,arguments.length,x0) }),
      _1649: x0 => ({createScriptURL: x0}),
      _1650: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1651: (x0,x1) => x0.appendChild(x1),
      _1652: (x0,x1) => x0.querySelectorAll(x1),
      _1653: x0 => x0.random(),
      ...
      _1673: () => new webkitSpeechRecognition(),
      ...
      _1678: x0 => x0.stop(),
      _1679: (x0,x1) => { x0.continuous = x1 },
      _1680: (x0,x1) => { x0.interimResults = x1 },
      _1681: (x0,x1) => { x0.lang = x1 },
      _1682: (x0,x1) => { x0.onresult = x1 },
      _1683: (x0,x1) => { x0.onerror = x1 },
      _1684: (x0,x1) => { x0.onend = x1 },
      _1686: x0 => x0.results,
      _1688: x0 => x0.length,
      _1689: (x0,x1) => x0.item(x1),
      _1692: (x0,x1) => x0.item(x1),
      _1693: x0 => x0.isFinal,
      _1694: x0 => x0.transcript,
      _1696: x0 => x0.error,
      _1817: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1818: f => finalizeWrapper(f, function() { return dartInstance.exports._1818(f,arguments.length) }),
      _2144: (x0,x1) => { x0.nonce = x1 },
      _3182: (x0,x1) => { x0.src = x1 },
      _3188: (x0,x1) => { x0.async = x1 },
      _3190: (x0,x1) => { x0.defer = x1 },
      _3651: () => globalThis.window,
      _3692: x0 => x0.document,
      _3695: x0 => x0.location,
      _3714: x0 => x0.navigator,
      _3976: x0 => x0.trustedTypes,
      _3989: x0 => x0.protocol,
      _3993: x0 => x0.hostname,
      _4087: x0 => x0.mediaDevices,
      _4154: x0 => x0.data,
      _4528: x0 => x0.readyState,
      _4537: x0 => x0.protocol,
      _4541: (x0,x1) => { x0.binaryType = x1 },
      _4544: x0 => x0.code,
      _4545: x0 => x0.reason,
      _5697: x0 => x0.sampleRate,
      _5700: x0 => x0.state,
      _5805: x0 => x0.fftSize,
      _5806: (x0,x1) => { x0.fftSize = x1 },
      _5807: x0 => x0.frequencyBinCount,
      _5809: (x0,x1) => { x0.minDecibels = x1 },
      _5811: (x0,x1) => { x0.maxDecibels = x1 },
      _5813: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6248: x0 => x0.signal,
      _6257: x0 => x0.length,
      _6318: () => globalThis.document,
      _6391: x0 => x0.cookie,
      _6392: (x0,x1) => { x0.cookie = x1 },
      _6401: x0 => x0.head,
      ...
      _8265: x0 => x0.size,
      _8286: x0 => x0.result,
      _8293: (x0,x1) => { x0.onload = x1 },
      _8297: (x0,x1) => { x0.onerror = x1 },
      _8665: (x0,x1) => { x0.ondataavailable = x1 },
      _8690: x0 => x0.data,
      _8780: x0 => x0.url,
      _8782: x0 => x0.status,
