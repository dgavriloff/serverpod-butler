...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1372: (x0,x1) => x0.getAttribute(x1),
      ...
      _1476: (t, s) => t.set(s),
      _1477: l => new DataView(new ArrayBuffer(l)),
      ...
      _1603: (x0,x1) => new WebSocket(x0,x1),
      _1604: (x0,x1) => x0.send(x1),
      _1605: (x0,x1,x2) => x0.close(x1,x2),
      _1607: x0 => x0.close(),
      ...
      _1616: x0 => x0.cancel(),
      _1617: x0 => x0.read(),
      _1618: (x0,x1) => ({video: x0,audio: x1}),
      _1619: (x0,x1) => x0.getUserMedia(x1),
      _1620: x0 => x0.getTracks(),
      _1621: () => new AudioContext(),
      _1622: x0 => x0.resume(),
      _1623: x0 => x0.createAnalyser(),
      _1624: (x0,x1) => x0.createMediaStreamSource(x1),
      _1625: (x0,x1) => x0.connect(x1),
      _1626: x0 => ({mimeType: x0}),
      _1627: (x0,x1) => new MediaRecorder(x0,x1),
      _1628: x0 => new MediaRecorder(x0),
      _1629: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1629(f,arguments.length,x0) }),
      _1630: (x0,x1) => x0.start(x1),
      _1631: () => new FileReader(),
      ...
      _1634: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1635: x0 => x0.stop(),
      _1636: x0 => x0.disconnect(),
      _1637: x0 => x0.close(),
      _1638: x0 => x0.stop(),
      _1639: (x0,x1) => x0.getByteFrequencyData(x1),
      _1640: x0 => x0.trustedTypes,
      _1641: (x0,x1) => { x0.src = x1 },
      _1642: (x0,x1) => x0.createScriptURL(x1),
      _1643: x0 => x0.nonce,
      _1644: (x0,x1) => x0.debug(x1),
      _1645: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1645(f,arguments.length,x0) }),
      _1646: x0 => ({createScriptURL: x0}),
      _1647: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1648: (x0,x1) => x0.appendChild(x1),
      _1649: (x0,x1) => x0.querySelectorAll(x1),
      _1650: x0 => x0.random(),
      _1651: (x0,x1) => x0.getRandomValues(x1),
      _1652: () => globalThis.crypto,
      _1653: () => globalThis.Math,
      ...
      _1670: () => new webkitSpeechRecognition(),
      ...
      _1675: x0 => x0.stop(),
      _1676: (x0,x1) => { x0.continuous = x1 },
      _1677: (x0,x1) => { x0.interimResults = x1 },
      _1678: (x0,x1) => { x0.lang = x1 },
      _1679: (x0,x1) => { x0.onresult = x1 },
      _1680: (x0,x1) => { x0.onerror = x1 },
      _1681: (x0,x1) => { x0.onend = x1 },
      _1683: x0 => x0.results,
      _1685: x0 => x0.length,
      _1686: (x0,x1) => x0.item(x1),
      _1689: (x0,x1) => x0.item(x1),
      _1690: x0 => x0.isFinal,
      _1691: x0 => x0.transcript,
      _1693: x0 => x0.error,
      _1814: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1815: f => finalizeWrapper(f, function() { return dartInstance.exports._1815(f,arguments.length) }),
      _2141: (x0,x1) => { x0.nonce = x1 },
      _3179: (x0,x1) => { x0.src = x1 },
      _3185: (x0,x1) => { x0.async = x1 },
      _3187: (x0,x1) => { x0.defer = x1 },
      _3648: () => globalThis.window,
      _3689: x0 => x0.document,
      _3692: x0 => x0.location,
      _3711: x0 => x0.navigator,
      _3973: x0 => x0.trustedTypes,
      _3975: x0 => x0.localStorage,
      _3986: x0 => x0.protocol,
      _3990: x0 => x0.hostname,
      _4084: x0 => x0.mediaDevices,
      _4151: x0 => x0.data,
      _4525: x0 => x0.readyState,
      _4534: x0 => x0.protocol,
      _4538: (x0,x1) => { x0.binaryType = x1 },
      _4541: x0 => x0.code,
      _4542: x0 => x0.reason,
      _5694: x0 => x0.sampleRate,
      _5697: x0 => x0.state,
      _5802: x0 => x0.fftSize,
      _5803: (x0,x1) => { x0.fftSize = x1 },
      _5804: x0 => x0.frequencyBinCount,
      _5806: (x0,x1) => { x0.minDecibels = x1 },
      _5808: (x0,x1) => { x0.maxDecibels = x1 },
      _5810: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6245: x0 => x0.signal,
      _6254: x0 => x0.length,
      _6315: () => globalThis.document,
      _6388: x0 => x0.cookie,
      _6389: (x0,x1) => { x0.cookie = x1 },
      _6398: x0 => x0.head,
      _6732: (x0,x1) => { x0.id = x1 },
      _8078: x0 => x0.value,
      _8080: x0 => x0.done,
      _8262: x0 => x0.size,
      _8283: x0 => x0.result,
      _8290: (x0,x1) => { x0.onload = x1 },
      _8294: (x0,x1) => { x0.onerror = x1 },
      _8662: (x0,x1) => { x0.ondataavailable = x1 },
      _8687: x0 => x0.data,
      _8777: x0 => x0.url,
      _8779: x0 => x0.status,
      _8781: x0 => x0.statusText,
      _8782: x0 => x0.headers,
      _8783: x0 => x0.body,
      _12406: x0 => x0.name,
