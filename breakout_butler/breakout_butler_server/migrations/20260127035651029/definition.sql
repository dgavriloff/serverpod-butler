...
--
-- Class ClassSession as table class_session
--
...
--
-- Class LiveSession as table live_session
--
...
--
-- Class TranscriptChunk as table transcript_chunk
--
...
--
-- Foreign relations for "live_session" table
--
...
--
-- Foreign relations for "transcript_chunk" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('breakout_butler', '20260127035651029', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260127035651029', "timestamp" = now();
